...
class DateTool
{
     ...
     */
    public
    static function dateDiff($interval, $startDateTime, $endDateTime)
    {
     ...
     */
    public
    static function dateAdd($interval, $value, $dateTime = null, $format = null)
    {
     ...
     */
    public
    static function getDaysByMonthsOfYear($year = null)
    {
        $year = $year ? $year : self::format('Y');
     ...
     */
    public
    static function getDaysByMonth($month, $year)
    {
     ...
     */
    public
    static function firstDayOfYear($year = null, $format = 'Y-m-d')
    {
        $year = $year ? $year : self::format('Y');
     ...
     */
    public
    static function lastDayOfYear($year = null, $format = 'Y-m-d')
    {
        $year = $year ? $year : self::format('Y');
     ...
     */
    public
    static function firstDayOfMonth($month = null, $year = null, $format = 'Y-m-d')
    {
        $year = $year ? $year : self::format('Y');
     ...
     */
    public
    static function lastDayOfMonth($month = null, $year = null, $format = 'Y-m-d')
    {
        $year = $year ? $year : self::format('Y');
        $month = $month ? $month : self::format('m');
     ...
     */
    public
    static function getDayRangeInBetweenDate($startDateTime, $endDateTime, $sort = false, $format = 'Y-m-d')
    {
     ...
     */
    public static function gettime($time, $end_time)
    {
        $strtime = '';
        $time = $end_time - $time;
        if ($time >= 86400) {
